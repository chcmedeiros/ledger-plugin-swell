...
const PLUGIN_LIB_NANOS = { 'Swell': Resolve("elfs/plugin_nanos.elf") };
const PLUGIN_LIB_NANOX = { 'Swell': Resolve("elfs/plugin_nanox.elf") };
const PLUGIN_LIB_NANOSP = { 'Swell': Resolve("elfs/plugin_nanosp.elf") };
